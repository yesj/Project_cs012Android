...
public class UartService extends Service {
    ...
    public final static String ACTION_GATT_SERVICES_HEART_RATE_DISCOVERED =
            "com.alatech.cs012.ACTION_GATT_SERVICES_HEART_RATE_DISCOVERED";
    public final static String ACTION_SERIVCES_HEART_RATE =
            "com.alatech.cs012.ACTION_SERIVCES_HEART_RATE";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
        	...
        	if (HR_CHARACTERISTIC_UUID.equals(characteristic.getUuid())) {
        		...
        		String stringValue = Integer.toString(hrValue);
        		broadcastUpdate(ACTION_SERIVCES_HEART_RATE,stringValue);
        	}
        }
    };
    ...
    /**
     * Enable HeartRateNotification
     *
     * @return 
     */
    public void enableHeartRateNotification() { 
    	BluetoothGattService RxService = mBluetoothGatt.getService(HR_SERVICE_UUID);
    	if (RxService == null) {
            showMessage("HeartRate service not found!");
            broadcastUpdate(DEVICE_DOES_NOT_SUPPORT_UART);
            return;
        }
    	BluetoothGattCharacteristic HeartRateMessageChar = RxService.getCharacteristic(HR_CHARACTERISTIC_UUID);
        if (HeartRateMessageChar == null) {
            showMessage("HeartRateMessage charateristic not found!");
            broadcastUpdate(DEVICE_DOES_NOT_SUPPORT_UART);
            return;
        }
        		Log.i("Chandler","HR_SERVICE_UUID");
		        mBluetoothGatt.setCharacteristicNotification(HeartRateMessageChar,true);
		        BluetoothGattDescriptor descriptor = HeartRateMessageChar.getDescriptor(CCCD);
